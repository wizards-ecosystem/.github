...
Every project here states what is actually built, in one place, and that page is
authoritative over any README, roadmap, or design document:
...
Much of what looks like a bug is a documented limit. Checking costs a minute.
...
resolved by a new decision record, not by an issue.
