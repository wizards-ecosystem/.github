...
<main><section class="intro"><p class="eyebrow">The identity collection / Edition 03</p><h1>One hand.<br><em>Twelve instruments.</em></h1><p>A calligraphic signature, ink-cut lettering, and a tool of its own. Every mark rests directly on the surface it belongs to.</p><nav aria-label="Brand resources"><a href="README.md">Use the assets</a><a href="../BRAND.md">Brand guide</a><a href="manifest.json">Asset manifest</a></nav></section><section aria-label="Project identities">${rows}</section><footer>Transparent SVG logos and icons. Outlined lettering. Local fonts. The watercolor studies remain in each project's art and lockup exports.</footer></main><script src="gallery.js"></script></body></html>\n`,
);
