...
`CODE_OF_CONDUCT.md` overrides it.

## The standard

Be straightforward and be decent. Technical disagreement is welcome and expected;
contempt is not.
...
- Accept a decision once it is made and recorded, or reopen it properly with a new
  decision record. Re-litigating settled questions in unrelated threads wastes everyone.
- No harassment, no personal attacks, no sexualized language or imagery, no publishing
  anyone's private information, and no sustained disruption.
